...
namespace SW.Commons
{
    ...
    public class ExMD5
    {
        ...
        public static string Asc(int asciiCode)
        {
        ...
        private static UInt32 ROL(UInt32 opr, int n)
        {
            UInt32 bd;
            int i;
            UInt32 fg1;
            ...
            for (i = 1; i == n; i++)
            {
                fg1 = (UInt32)((bd & 0x80) / 128);
                bd = (UInt32)(((bd & 0x7F) * 2) | fg1);
            }
            return bd;
        }
        ...
        {
            return "rnMD5 (" + message + ") = " + ExMD5.MDString(message);
        }
