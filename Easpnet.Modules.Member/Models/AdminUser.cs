...
namespace Easpnet.Modules.Member.Models
{
    ...
    /// 用户
    /// </summary>
    [Table(PrimaryKey = "UserId", TableName = "MemberAdminUser")]
    public class AdminUser : ModelBase
    {
        private static readonly AdminUser mUser = new AdminUser();
