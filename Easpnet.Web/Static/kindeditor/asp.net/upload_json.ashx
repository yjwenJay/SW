...
public class Upload : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
	...
	//文件保存目录URL
    private String saveUrl = "Static/UploadFiles/";
	//定义允许上传的文件扩展名
	...
	public void ProcessRequest(HttpContext context)
	{
        ...
        saveUrl = Easpnet.Modules.Html.Url(saveUrl);
          
        //若已经登录，则上传到该用户的文件夹下面
        if (MemberContext.IsLogin)
        {
            savePath += "user/" + MemberContext.LoginUserName + "/";
            saveUrl += "user/" + MemberContext.LoginUserName + "/";
        }
        else
        {
