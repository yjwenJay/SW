<%@ Control Language="C#" AutoEventWireup="true" Inherits="Easpnet.Modules.Core.Pages.AdminPageBlockManage" %>
<div class="pageContent">
    <div class="panelBar">
		<ul class="toolBar">
			<li><a href="javascript:void(0)" id="save_page"><span>保存布局</span></a></li>
			<li class="line">line</li>		
			<li><a href="<%=Html.HrefLink("Core","AdminPageManager", "")%>" id="A1"><span>取消</span></a></li>	
		</ul>
	</div>

    <form action="<%=Html.HrefLink("Core", "AdminPageBlockManage", "pid=" + Get("pid")) %>" method="post" id="form-main">	
	                ...
	                <li class="accessible"><a href="javascript:void(0);" class="accessible">顶部栏目 &raquo;</a>
		                <ul>
                            ...
                            <li class="edit_column_visibility" action="open">打开栏目</li>      
                             <% }%>
					        <li><a href="<%=Html.HrefLink("Core","AdminPageBlockAdd","btype=top" + "&pid=" + Get("pid"))%>">添加区块</a></li>
		                </ul>
	                </li>
                </ul>
                </span>
                ...
                <ul class="jd_menu">
		            <li class="accessible"><a href="javascript:void(0);" class="accessible">左侧栏目 &raquo;</a>
			            <ul>
                            ...
                            <li class="edit_column_visibility" action="open">打开栏目</li>      
                             <% }%>
					        <li><a href="<%=Html.HrefLink("Core","AdminPageBlockAdd","btype=left" + "&pid=" + Get("pid"))%>">添加区块</a></li>
			            </ul>
		            </li>
	            </ul>
	            </span>
                ...
                <ul class="jd_menu">
			        <li class="accessible"><a href="javascript:void(0);" class="accessible">右侧栏目 &raquo;</a>
				        <ul>
                            ...
                            <li class="edit_column_visibility" action="open">打开栏目</li>      
                             <% }%>
					        <li><a href="<%=Html.HrefLink("Core","AdminPageBlockAdd","btype=right" + "&pid=" + Get("pid"))%>">添加区块</a></li>
				        </ul>
			        </li>
		        </ul>
		        </span>
                ...
                <ul class="jd_menu">
	                <li class="accessible"><a href="javascript:void(0);" class="accessible">底部栏目 &raquo;</a>
		                <ul>
                            ...
                            <li class="edit_column_visibility" action="open">打开栏目</li>      
                             <% }%>
					        <li><a href="<%=Html.HrefLink("Core","AdminPageBlockAdd","btype=bottom" + "&pid=" + Get("pid"))%>">添加区块</a></li>
		                </ul>
	                </li>
                </ul>
                </span>
