...
function DHTMLgoodies_formTooltip()
{
	...
	this.arrowImageFileRight = 'pointer.gif';
	this.tooltipWidth = 200;
	this.tooltipBgColor = '';
	this.closeMessage = '关闭';
	this.disableTooltipMessage = '不再显示';
	this.activeInput = false;
	this.tooltipPosition = 'right';
	this.arrowRightWidth = 15;			// Default width of arrow when the tooltip is on the right side of the inputs.
	this.arrowTopHeight = 0;			// Default height of arrow at the top of tooltip
...
DHTMLgoodies_formTooltip.prototype = {
    ...
    */
    __createTooltip: function() {
        ...
        this.tooltipDiv.id = 'DHTMLgoodies_formTooltipDivBox';
...
//        outerDiv.appendChild(closeDiv);
    ...
    */
    getLeftPos: function(inputObj) {
        ...
        return returnValue + this.arrowRightWidth;
    }
