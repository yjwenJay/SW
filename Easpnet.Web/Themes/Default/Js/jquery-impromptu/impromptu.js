...
jQuery.extend({
    ...
    prompt: function(m, o) {
        ...
        msgbox += '<div class="' + o.prefix + '" id="' + o.prefix + '"><div id="jqititle"><p class="pTitleMessage">' + m + '</p><div class="' + o.prefix + 'close"></div></div><div class="' + o.prefix + 'container"><div class="' + o.prefix + 'message">' + m + '</div><div class="' + o.prefix + 'buttons" id="' + o.prefix + 'buttons">';
        ...
        }).hover(function() { $(this).addClass("button_over"); }, function() { $(this).removeClass("button_over"); });
